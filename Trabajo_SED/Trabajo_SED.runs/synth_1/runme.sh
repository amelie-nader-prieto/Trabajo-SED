...
HD_PWD='C:/Users/sergi/OneDrive/Desktop/Trabajo info/Trabajo-SED/Trabajo_SED/Trabajo_SED.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decodificador_moneda.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decodificador_moneda.tcl
